...
Results visualizations return ggplot2 objects. Volcano plots are useful for 
summarizing results of univariate tests. Manhattan plots and cloud plots can be 
used to relate results to biochemical features such as m/z and RT and are 
plotted separately for each mode. To save these functions to a PDF file, use 
`save_plot`.
